...
if (isset($_POST["employeenumber"]) && isset($_POST["password"])) {
    ...
    WHERE users.userid = '$employeenumber' AND users.pin = '$password' AND users.usertypeid = 2");
...
<head>
    ...
    <style>
        ...
        .bg-cover {
            background-image: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('../img/teacherportal.png');
...
<body>
    ...
    <div class="bg-cover d-flex justify-content-center align-items-center">
        <div class="text-center text-white">
            <div class="card mt-3 col-md-8 mx-auto p-2">
                <div class="card-body">
                    <?php
                    ...
                    <h2 class="card-title text-center my-3">Bayanan Elementary School Main Faculty Portal</h2>
