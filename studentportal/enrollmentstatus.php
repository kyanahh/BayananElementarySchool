...
if (isset($userid) && !empty($userid)) {
    $stmt = $connection->prepare("
        SELECT enrollment_applications.*, grade_levels.grade_name, class_sections.section_name  
        FROM enrollment_applications 
        INNER JOIN grade_levels
            ON enrollment_applications.gradeid = grade_levels.grade_id 
        INNER JOIN class_section_assignments 
            ON class_section_assignments.sectionid = class_sections.sectionid 
