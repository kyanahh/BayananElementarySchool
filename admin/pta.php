...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="px-3 pt-4">
                    <div class="row">
                        <div class="col-sm-1">
                            <h2 class="fs-5 mt-1 ms-2">PTA</h2>
                        </div>
                        <div class="col input-group mb-3 ms-4">
                            <input type="text" class="form-control" id="searchPTAInput" placeholder="Search" aria-describedby="button-addon2" oninput="searchPTA()">
                        </div>
                        <div class="col-sm-1">
                            <a href="pta_add.php" class="btn btn-dark px-4"><i class="bi bi-plus-lg text-white"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="card" style="height: 600px;">
                        <div class="card-body">
                            <div class="table-responsive" style="height: 550px;">
                                <table id="pta-table" class="table table-bordered table-hover">
    ...
    <script>
        //---------------------------Search  Posts---------------------------//
        function searchPTA() {
            const query = document.getElementById("searchPTAInput").value;

            // Make an AJAX request to fetch search results
            $.ajax({
                url: 'pta_search.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
                success: function(data) {
                    // Update the sched-table with the search results
                    $('#pta-table tbody').html(data);
                },
        ...
        //---------------------------Edit Post ---------------------------//
        function editPTA(ptaid) {
            window.location = "pta_edit.php?ptaid=" + ptaid;
        }
