...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="col offset-2 offset-sm-3 offset-xl-2 d-flex flex-column vh-100">
                ...
                <!-- List of Grade Assignments -->
                <div class="px-3 pt-4">
                    <div class="row">
                        <div class="col-sm-2">
                            <h2 class="fs-5 mt-1 ms-2">Grade Assignments</h2>
                        </div>
                        <div class="col input-group mb-3 ms-4">
                            <input type="text" class="form-control" id="searchGradeInput" placeholder="Search" aria-describedby="button-addon2" oninput="searchGrade()">
                        </div>
                        <div class="col-sm-1">
                            <a href="grade_assignmentadd.php" class="btn btn-dark px-4"><i class="bi bi-plus-lg text-white"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="card" style="height: 600px;">
                        <div class="card-body">
                            <div class="table-responsive" style="height: 550px;">
                                <table id="assignment-table" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $result = $connection->query("SELECT student_grade_levels.*, users.firstname, 
                ...
                <!-- End of List of Grade Assignments -->
                ...
                <div id="liveToast" class="toast align-items-center text-white bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body" id="toastMessage">
                            Grade assignment added successfully!
                        </div>
    ...
    <script>
        ...
        function searchGrade() {
            const query = document.getElementById("searchGradeInput").value;

            // Make an AJAX request to fetch search results
            $.ajax({
                url: 'grade_assignmentsearch.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
        ...
        function editGrade(id) {
            window.location = "grade_assignmentedit.php?id=" + id;
        }
        ...
        document.getElementById('confirmDeleteButton').addEventListener('click', function () {
            if (gradeIdToDelete) {
                $.ajax({
                    url: "grade_assignmentdelete.php",
                    method: "POST",
                    data: { gradeId: gradeIdToDelete },
                    dataType: "json",
