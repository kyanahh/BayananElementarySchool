...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="px-3 pt-4">
                    <div class="row">
                        <div class="col-sm-3">
                            <h2 class="fs-5 mt-1 ms-2">Upcoming Events</h2>
                        </div>
                        ...
                        <div class="col-sm-1">
                            <a href="eventsadd.php" class="btn btn-dark px-4"><i class="bi bi-plus-lg text-white"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive" style="height: 550px;">
                                <table id="announcement-table" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $result = $connection->query("SELECT events.id, events.postitle, events.postdesc, 
    ...
    <script>
        ...
        function search() {
            ...
            $.ajax({
                url: 'events_search.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
        ...
        //---------------------------Edit Post ---------------------------//
        function edit(id) {
            window.location = "events_edit.php?id=" + id;
        }
        ...
        document.getElementById('confirmDeleteButton').addEventListener('click', function () {
            if (IdToDelete) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        showToast("Error deleting the Event Post", "bg-danger");
                    }
                });
            }
        });
