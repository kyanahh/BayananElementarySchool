...
if (isset($_GET["ptaid"]) && !empty($_GET["ptaid"])) {
    $ptaid = $_GET["ptaid"];

    $query = "SELECT pta.ptaid, pta.ptatitle, pta.ptapost, 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $ptatitle = $_POST["ptatitle"];
    $ptapost = $_POST["ptapost"];

    $insertQuery = "UPDATE pta   
                    SET  
                    ptatitle = '$ptatitle',                    
                    ptapost = '$ptapost'                    
                    WHERE ptaid = '$ptaid'";
        ...
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="container px-3 pt-4">
                    <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">
                        ...
                        <div class="row mt-1">
                            <h2 class="fs-5">Edit PTA Post</h2>
                        </div>
                        ...
                        <div class="row mb-3 mt-2 align-items-center">
                            <div class="col-sm-2">
                                <label class="form-label">PTA Post ID</label>
                            </div>
                            <div class="col-sm-4">
                                <input type="text" class="form-control shadow" name="ptaid" id="ptaid" value="<?php echo $ptaid; ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 mt-2">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control shadow" id="ptapost" name="ptapost" rows="10" value="<?php echo $ptapost; ?>" placeholder="Description here"><?php echo $ptapost; ?></textarea>                            
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 mt-2 align-items-center">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control shadow" name="postedby" id="postedby" value="<?php echo $firstname . ' ' . $lastname; ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 mt-2 align-items-center">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control shadow" name="datepost" id="datepost" value="<?php echo $datepost; ?>" disabled>
                            </div>
                        </div>
