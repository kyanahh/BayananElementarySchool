...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "UPDATE class_section_assignments  
                    SET  
                    sectionid = '$sectionid'                    
                    WHERE assignmentid = '$assignmentid'";
        ...
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="container px-3">
                    <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">
                        ...
                        <div class="row mt-1">
                            <h2 class="fs-5">Edit Class Assignment</h2>
                        </div>
                                ...
                                if ($gradeResult && $gradeResult->num_rows > 0) {
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $selected = ($row['section_id'] == $sectionid) ? "selected" : ""; // Compare with $sectionid
                        ...
                        <div class="row mb-3 mt-2 align-items-center">
                            ...
                            <div class="col-sm-4">      
                                <input type="text" class="form-control" name="assignedby" id="assignedby" value="<?php echo $firstname . ' ' . $lastname ?>" disabled>
                            </div>
                        </div>
