...
if (isset($_GET["id"]) && !empty($_GET["id"])) {
    ...
    $query = "SELECT announcements.id, announcements.postitle, announcements.postdesc, 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "UPDATE announcements   
                    SET  
                    postitle = '$postitle',                    
                    postdesc = '$postdesc'                    
                    WHERE id = '$id'";
        ...
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="container px-3 pt-4">
                    <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">
                        ...
                        <div class="row mt-1">
                            <h2 class="fs-5">Edit Announcement</h2>
                        </div>
