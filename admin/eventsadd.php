...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $postdesc =  ucwords($_POST["postdesc"]);

    // Insert the user data into the database
    $insertQuery = "INSERT INTO events (postitle, postdesc, postedby, dateposted) 
    VALUES ('$postitle', '$postdesc', '$usersid', '$currentDate')";
...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <!-- Add Upcoming Event Post -->
            <div class="container px-3 pt-4">
                    <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">

                        <div class="row mt-1">
                            <h2 class="fs-5">Add Upcoming Event Announcement</h2>
                        </div>
                        ...
                        <div class="row mb-3 mt-2 align-items-center">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control shadow" name="postitle" id="postitle" value="<?php echo $postitle; ?>" placeholder="Title" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 mt-2">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control shadow" id="postdesc" name="postdesc" rows="10" value="<?php echo $postdesc; ?>" placeholder="Description here"></textarea>                            
                            </div>
                        </div>
                ...
                <!-- End of Add Upcoming Event Post -->
