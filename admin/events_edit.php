...
if (isset($_GET["id"]) && !empty($_GET["id"])) {
    ...
    $query = "SELECT events.id, events.postitle, events.postdesc, 
...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <!-- Edit Upcoming Event Announcement Post -->
            <div class="container px-3 pt-4">
                    <form method="POST" action="<?php htmlspecialchars("SELF_PHP"); ?>">

                        <div class="row mt-1">
                            <h2 class="fs-5">Edit Upcoming Event Announcement</h2>
                        </div>
                        ...
                        <div class="row mb-3 mt-2">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control shadow" id="postdesc" name="postdesc" rows="10" value="<?php echo $postdesc; ?>" placeholder="Description here"><?php echo $postdesc; ?></textarea>                            
                            </div>
                        </div>
                ...
                <!-- End of Edit Upcoming Event Announcement Post -->
