...
<body>
        ...
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="col offset-2 offset-sm-3 offset-xl-2 d-flex flex-column vh-100 pt-4">
                ...
                <div class="px-3">
                    <div class="row">
                        <div class="col-sm-1">
                            <h2 class="fs-5 mt-1 ms-2">Admission</h2>
                        </div>
                        ...
                        <div class="col-sm-1">
                            <a href="admissionadd.php" class="btn btn-dark px-4"><i class="bi bi-plus-lg text-white"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive" style="height: 420px;">
                                <table id="user-table" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $result = $connection->query("SELECT addid, firstname, 
                                        lastname, email, username, DATE_FORMAT(bday, '%M %d, %Y') AS bday
                                        FROM admission ORDER BY addid DESC");
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            echo '<tr><td colspan="5">No admission found.</td></tr>';
                                        }
                                    ?>
                                    </tbody>
                                </table>
  ...
  <script>
        ...
        function editUser(id) {
            window.location = "admissionedit.php?id=" + id;
        }
        ...
        function deleteUser(id) {
            addIdToDelete = id; // Store the user ID to delete
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            if (addIdToDelete) {
                $.ajax({
                    url: 'admissiondelete.php',
                    method: 'POST',
                    data: { addid: addIdToDelete },
                    dataType: 'json',
        ...
        function searchUsers() {
            ...
            $.ajax({
                url: 'admissionsearch_users.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
