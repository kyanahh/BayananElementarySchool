...
<body>
    ...
    <div class="container-fluid overflow-hidden">
        <div class="row g-0 vh-100 overflow-y-auto">
            ...
            <div class="px-3 pt-4">
                    <div class="row">
                        <div class="col-sm-1">
                            <h2 class="fs-5 mt-1 ms-2">Inquiries</h2>
                        </div>
                    ...
                    <div class="card" style="height: 600px;">
                        <div class="card-body">
                            <div class="table-responsive" style="height: 550px;">
                                <table id="inquiry-table" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $result = $connection->query("SELECT * FROM inquiry 
    ...
    <script>
        ...
        function search() {
            ...
            $.ajax({
                url: 'inquiry_search.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
                success: function(data) {
                    // Update the sched-table with the search results
                    $('#inquiry-table tbody').html(data);
                },
        ...
        document.getElementById('confirmDeleteButton').addEventListener('click', function () {
            if (IdToDelete) {
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        showToast("Error deleting the inquiry", "bg-danger");
                    }
                });
            }
        });
