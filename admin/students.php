...
<body>
            ...
            <div class="col offset-2 offset-sm-3 offset-xl-2 d-flex flex-column vh-100 pt-4">
                ...
                <div class="px-3">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <a href="studentsadd.php" class="btn btn-dark px-4"><i class="bi bi-plus-lg text-white"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive" style="height: 420px;">
                                <table id="user-table" class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        FROM users WHERE usertypeid = 3 ORDER BY userid DESC");
  ...
  <script>
        ...
        function editUser(id) {
            window.location = "studentsedit.php?id=" + id;
        }
        ...
        function searchUsers() {
            ...
            $.ajax({
                url: 'studentsearch_users.php', // Replace with the actual URL to your search script
                method: 'POST',
                data: { query: query },
